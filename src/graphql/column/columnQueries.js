...
export const ADD_COLUMN = gql`
    mutation addColumnForBoard($boardId: ID!, $columnName: String!, $eventId: ID!, $hidden : String!) {
        addColumnForBoard(boardId: $boardId, columnName: $columnName, eventId: $eventId, hidden: $hidden) {
            id
            name
            hidden
            board {
