...
const schema = {
    ...
    Mutation: {
        async addColumnForBoard(root, { boardId, columnName, eventId, hidden }) {
            let createdColumn
            try {
                createdColumn = await dataSources.boardService.addColumnForBoard(boardId, columnName, hidden)
